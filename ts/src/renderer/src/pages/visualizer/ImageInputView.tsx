...
export default function ImageInputView(): JSX.Element {
  ...
  return (
    <div className="flex flex-1 gap-4 overflow-hidden p-4">
      {imagePath && (
        <div className="h-full w-2/3 overflow-hidden rounded-xl bg-primary shadow">
          <NeuralImageInput
            imagePath={imagePath}
      ...
      {!imagePath && (
        <div className="flex h-full w-2/3 items-center justify-center overflow-hidden rounded-xl bg-primary shadow">
      ...
      <div className="flex h-full w-1/3 flex-col gap-4 overflow-y-auto">
        <div className="rounded-xl bg-white p-4 shadow">
          <h3 className="mb-2 font-semibold text-primary">Feed Image to Model</h3>
        ...
        {imagePath && (
          <div className="flex-1 rounded-xl bg-white p-4 shadow">
            <h3 className="mb-2 font-semibold text-primary">Node Stats</h3>
